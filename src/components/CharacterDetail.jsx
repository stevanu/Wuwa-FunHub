...
function CharacterDetail() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,215,0,0.15),transparent_64%)] 
      pointer-events-none"
      />
      ...
      <div className="max-w-8xl mx-auto px-6 md:px-16 py-10 relative z-10">
        <Link
          ...
          transition-colors duration-300 mb-9 border border-amber-200/50 hover:border-amber-300
